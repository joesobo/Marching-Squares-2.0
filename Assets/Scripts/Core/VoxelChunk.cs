...
public class VoxelChunk : MonoBehaviour {
    ...
    // Storage of relationship between vertices and indices
    public readonly Dictionary<Vector3, int> verticeDictionary = new Dictionary<Vector3, int>();
